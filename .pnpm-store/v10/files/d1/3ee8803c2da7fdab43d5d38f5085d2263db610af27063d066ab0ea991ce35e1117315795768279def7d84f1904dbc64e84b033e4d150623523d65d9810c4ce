...
function computeDependencies(node, dependencyDetection) {
  let dependencies = []
  checkNode(node)
  return dependencies
  function checkNode(nodeToCheck, options) {
    ...
    function checkNodesForCommonDependencies() {
      if (
    ...
    function checkNodesForSoftDependencies() {
  ...
  function traverseNode(nodeToTraverse, options) {

...
export const constantRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: "tasks",
        component: () => import("@/pages/crawlee/tasks/index.vue"),
        name: "CrawleeTasks",
        meta: {
          title: "任务",
          svgIcon: "dashboard"
      ...
      {
        path: "tasks/create/smart",
        component: () => import("@/pages/crawlee/smart-create/index.vue"),
        name: "CrawleeSmartCreate",
        meta: {
          title: "智能创建任务",
          hidden: true,
          activeMenu: "/crawlee/tasks"
        }
      },
      {
        path: "tasks/:taskId",
        component: () => import("@/pages/crawlee/task-detail/index.vue"),

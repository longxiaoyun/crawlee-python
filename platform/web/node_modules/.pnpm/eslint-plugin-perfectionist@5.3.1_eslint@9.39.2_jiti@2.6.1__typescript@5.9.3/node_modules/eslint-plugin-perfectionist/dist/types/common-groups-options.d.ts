import { CommonOptions, RegexOption } from './common-options.js'
...
export interface AnyOfCustomGroup<MatchOptions> {
  ...
  elementNamePattern?: RegexOption
  /**
   * Array of patterns where matching any single pattern includes the element
   * in the group. Provides OR logic for group membership.
   */
